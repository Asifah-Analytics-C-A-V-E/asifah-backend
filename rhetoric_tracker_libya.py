...
# Google News RSS hands back articles months/years old regardless of the day
# window; without decay a 13-month-old "clashes erupt" headline pins the theatre
# at a live L4. A fresh article scores at full strength; its contribution fades
# linearly to zero by RECENCY_ZERO_DAYS. Estimative doctrine: stale is context,
# not a present-tense signal. Undated items default to full weight so we never
# suppress real-time social posts. Tunable via the two constants below.
# ============================================================================
