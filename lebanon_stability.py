...
HEZBOLLAH_LEADERSHIP = {
    'naim_qassem': {
        ...
        'since': '2024-10-29',
        'note': 'Replaced Hassan Nasrallah after assassination Sep 27, 2024. Declared "marked target" by Israel Defense Minister Katz Mar 2, 2026. Lebanese govt considering legal action.',
        'keywords_alive': ['naim qassem speech', 'qassem statement', 'qassem addresses',
                           ...
                           'qassem marked target', 'qassem targeted',
                           # Arabic
    ...
    'hashem_safieddine': {
        ...
        'since': '2000-01-01',
        'note': 'Reported killed Oct 2024; status disputed. Was considered likely successor to Nasrallah.',
    ...
    'hussein_makled': {
        ...
        'title_ar': 'رئيس جهاز الاستخبارات',
        'since': None,
        'confirmed_status': 'killed',
        'note': 'Killed in IDF overnight strike in Beirut, Mar 2, 2026. Headed Hezbollah intelligence HQ. Responsible for intel collection and assessments on IDF.',
        'keywords_alive': ['makled alive', 'makled statement'],
        'keywords_killed': ['makled killed', 'hussein makled killed', 'hezbollah intel chief killed',
                            'hezbollah intelligence killed', 'makled eliminated',
                            'مقتل حسين مكلد', 'رئيس استخبارات حزب الله قتل'],
        'keywords_unknown': ['makled status'],
    },
    'mohammad_raad': {
        'name': 'Mohammad Raad',
        'title': 'Head of Parliamentary Faction',
        'title_ar': 'رئيس كتلة الوفاء للمقاومة',
        'since': None,
        'confirmed_status': 'alive',
        'note': 'Reports of death on March 2, 2026 were false. Raad voted in Lebanese parliamentary elections March 9, 2026. Remains head of Loyalty to the Resistance Bloc. Son was killed in previous war.',
        'keywords_alive': ['raad alive', 'raad speech', 'raad parliament', 'raad statement',
                           'raad votes', 'raad attends', 'raad appears'],
        'keywords_killed': ['mohammad raad killed', 'raad killed', 'hezbollah parliament killed',
                            'raad eliminated', 'raad dead',
                            'مقتل محمد رعد', 'رعد قتل'],
        'keywords_unknown': ['raad status', 'raad unconfirmed'],
    },
    'abu_hussein_raab': {
        'name': 'Abu Hussein Raab',
        'title': 'Nasr Unit Commander',
        'title_ar': 'قائد وحدة النصر',
        'since': None,
        'confirmed_status': 'killed',
        'note': 'Killed in targeted IDF strike, Mar 8-9, 2026. Commanded Hezbollah Nasr Unit. Confirmed by Israeli Defense Minister.',
        'keywords_alive': ['nasr unit commander', 'nasr unit active'],
        'keywords_killed': ['abu hussein raab killed', 'nasr unit commander killed',
                            'nasr commander eliminated', 'raab killed',
                            'مقتل قائد وحدة النصر'],
        'keywords_unknown': ['nasr unit status', 'nasr commander unknown'],
    },
